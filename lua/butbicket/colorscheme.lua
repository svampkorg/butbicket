...
if vim.o.background == 'light' then
  ...
  colorscheme.commandText = fromBitBucket.variable
  colorscheme.inactiveText = fromBitBucket.slate
  colorscheme.disabledText = fromBitBucket.annotation
  colorscheme.lineNumberText = fromBitBucket.dark_slate
  ...
  colorscheme.syntaxError = fromBitBucket.red
  colorscheme.syntaxFunction = fromBitBucket.method
  colorscheme.warningText = fromBitBucket.mustard
  colorscheme.syntaxKeyword = fromBitBucket.keyword
  colorscheme.linkText = fromBitBucket.blue
  colorscheme.stringText = fromBitBucket.stringText
  colorscheme.warningEmphasis = fromBitBucket.yellow
  colorscheme.successText = fromBitBucket.green
  colorscheme.errorText = fromBitBucket.red
  colorscheme.specialKeyword = fromBitBucket.method
  colorscheme.commentText = fromBitBucket.dark_slate
