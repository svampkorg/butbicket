...
local diff_text = utils.shade(colorscheme.old_mustard, 0.5, colorscheme.editorBackground)
...
return {
	...
	IncSearch = {
		bg = utils.mix(colorscheme.purple, colorscheme.editorBackground, math.abs(0.30)),
	},
	...
	PmenuSbar = {
		bg = utils.shade(colorscheme.floatBorder, 0.5, colorscheme.editorBackground),
	},
	...
	DiagnosticLineError = {
		bg = utils.shade(colorscheme.syntaxError, 0.1, colorscheme.editorBackground),
	},
	DiagnosticLineWarn = {
		bg = utils.shade(colorscheme.warningText, 0.1, colorscheme.editorBackground),
	},
	DiagnosticLineInfo = {
